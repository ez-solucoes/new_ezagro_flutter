...
class AppColors {
  ...
  static const Color whiteColor = Color(0xffFDF6ED);
  static const Color trueWhiteColor = Color(0xffFDFDFD);
  static const Color contourWhiteColor = Color(0xfff3f3f3);
  static const Color blackColor = Color(0xff171717);
  static const Color greyColor = Color(0xff676767);
  static const Color softGreyColor = Color(0xffD7D7D7);
