...
abstract class AgriculturalActivityTypeDatasource {
  Future<ResponseModel<List<TypeModel>>> getAllAgriculturalActivityTypes(NoParams noParams);
  Future<ResponseModel<List<SelectModel>>> getAllAgriculturalActivityTypesToSelect(NoParams noParams);
