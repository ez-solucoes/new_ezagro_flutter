...
class UserDatasourceImpl with UriBuilder implements UserDatasource {
  ...
  @override
  Future<ResponseModel<PaginationModel<UserModel>>> getAllUsers(NoParams noParams) async {
    ...
    switch (result.statusCode) {
      case 200:
        return mountModelInstanceFromResponse(
          response: result,
          fromMap: (map) => PaginationModel.fromMap(map, UserModel.fromMap),
          fromJson: (jsonString) => PaginationModel.fromJson(jsonString, UserModel.fromMap),
        );
      default:
  ...
  @override
  Future<EmptyResult> updateUserById(UserParams userParams) async {
    final String url = mountUrl(
      AppEndpoints.baseUrlProtocolWithSecurity,
      AppEndpoints.mainBaseUrlDev,
      AppEndpoints.userEndpoint + userParams.id.toString(),
