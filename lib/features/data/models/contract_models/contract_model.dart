...
class ContractModel extends ContractEntity {
  ...
  factory ContractModel.fromMap(Map<String, dynamic> map) => ContractModel(
        ...
        contractedCompany: map['contractCompany'] == null
            ? null
            : CompanyModel.fromMap(map['contractedCompany']),
        ...
        contractType: map['contractType'] == null
            ? null
            : ContractTypeModel.fromMap(map['contractType']),
        attachmentNames: null,
        //map['attachmentNames'] == null ? null : List<String>.from(map['attachmentNames']),
        externalCode: map['externalCode'],
        contractCoverages: map['contractCoverages'] == null
            ? null
            : List<ContractCoverageModel>.from(map['contractCoverages']
                ?.map((x) => ContractCoverageModel.fromMap(x))),
        deductiblePrice: map['deductiblePrice'] == null
            ? null
            : (map['deductiblePrice'] is double
                ? map['deductiblePrice']
                : (map['deductiblePrice'] as int).toDouble()),
        fixedPrice: map['fixedPrice'] == null
            ? null
            : (map['fixedPrice'] is double
                ? map['fixedPrice']
                : (map['fixedPrice'] as int).toDouble()),
        items: map['items'] == null
            ? null
            : List<ContractItemModel>.from(
