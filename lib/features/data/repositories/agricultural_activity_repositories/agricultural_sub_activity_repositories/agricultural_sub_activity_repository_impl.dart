...
class AgriculturalSubActivityRepositoryImpl implements AgriculturalSubActivityRepository {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<AgriculturalSubActivityModel>>> getAgriculturalSubActivityById(ArgParams argParams) async {
    try {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<List<AgriculturalSubActivityModel>>>> getAllAgriculturalSubActivities(NoParams noParams) async {
    try {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<List<SelectModel>>>> getAllAgriculturalSubActivitiesToSelect(NoParams noParams) async {
    try {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<List<SelectModel>>>> getAllAgriculturalSubActivitiesByActivityIdToSelect(ArgParams argParams) async {
    try {
