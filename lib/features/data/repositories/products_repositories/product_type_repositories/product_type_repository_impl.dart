...
import '../../../../domain/repositories/product_repositories/product_type_repositories/product_type_repository.dart';
...
class ProductTypeRepositoryImpl implements ProductTypeRepository {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<List<ProductTypeModel>>>>
      getAllProductTypes(NoParams noParams) async {
    try {
  ...
  Future<Either<ApplicationError, ResponseModel<List<SelectModel>>>>
      getAllProductTypesToSelect(NoParams noParams) async {
    try {
  ...
  @override
  Future<Either<ApplicationError, ResponseModel<ProductTypeModel>>> getProductTypeById(
