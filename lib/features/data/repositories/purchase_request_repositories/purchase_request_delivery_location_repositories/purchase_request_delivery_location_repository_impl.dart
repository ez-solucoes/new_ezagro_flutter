...
class PurchaseRequestDeliveryLocationRepositoryImpl
    implements PurchaseRequestDeliveryLocationRepository {
  ...
  Future<Either<ApplicationError, ResponseModel<List<TypeModel>>>>
      getAllPurchaseRequestDeliveryLocations(NoParams noParams) async {
    try {
      ...
      return Left(GenericError(
          fingerprint:
              '$PurchaseRequestDeliveryLocationRepositoryImpl.getAllPurchaseRequestDeliveryLocations',
  ...
  Future<Either<ApplicationError, ResponseModel<List<SelectModel>>>>
      getAllPurchaseRequestDeliveryLocationsToSelect(NoParams noParams) async {
    try {
      final result =
          await datasource.getAllPurchaseRequestDeliveryLocationsToSelect(noParams);
      return Right(result);
    } on ApplicationError catch (e) {
      return Left(e);
    } catch (e, stacktrace) {
      return Left(GenericError(
          fingerprint:
              '$PurchaseRequestDeliveryLocationRepositoryImpl.getAllPurchaseRequestDeliveryLocationsToSelect',
          additionalInfo: stacktrace.toString()));
    }
  }

  @override
  Future<Either<ApplicationError, ResponseModel<TypeModel>>> getPurchaseRequestDeliveryLocationById(
    ...
    try {
      ...
      return Left(GenericError(
          fingerprint:
              '$PurchaseRequestDeliveryLocationRepositoryImpl.getPurchaseRequestDeliveryLocationById',
          additionalInfo: stacktrace.toString()));
    }
  }
}
