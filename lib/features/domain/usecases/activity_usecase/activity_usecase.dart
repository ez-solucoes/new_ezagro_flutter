...
abstract class ActivityUsecase implements Usecase<PaginationEntity<AgriculturalActivityEntity>, NoParams> {
  @override
  Future<Either<ApplicationError, PaginationEntity<AgriculturalActivityEntity>>> call(NoParams params);
}