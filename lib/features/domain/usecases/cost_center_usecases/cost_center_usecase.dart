...
abstract class CostCenterUsecase implements Usecase<PaginationEntity<CostCenterEntity>, NoParams> {
  @override
  Future<Either<ApplicationError, PaginationEntity<CostCenterEntity>>> call(NoParams params);
}