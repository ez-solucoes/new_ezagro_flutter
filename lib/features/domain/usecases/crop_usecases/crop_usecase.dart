...
abstract class CropUsecase implements Usecase<PaginationEntity<CropEntity>, NoParams> {
  @override
  Future<Either<ApplicationError, PaginationEntity<CropEntity>>> call(NoParams params);
}