...
abstract class ExecutorUsecase implements Usecase<PaginationEntity<EmployeeEntity>, NoParams> {
  @override
  Future<Either<ApplicationError, PaginationEntity<EmployeeEntity>>> call(NoParams params);
}