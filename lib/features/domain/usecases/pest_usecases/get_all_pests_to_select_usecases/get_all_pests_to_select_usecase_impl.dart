...
import 'get_all_pests_to_select_usecase.dart';

class GetAllPestsToSelectUsecaseImpl implements GetAllPestsToSelectUsecase{
  final PestRepository repository;

  const GetAllPestsToSelectUsecaseImpl(this.repository);
  @override
  Future<Either<ApplicationError, ResponseEntity<List<SelectEntity>>>> call(NoParams noParams) async {
    return await repository.getAllPestsToSelect(noParams);
  }
}