...
import 'package:new_ezagro_flutter/features/domain/repositories/product_repositories/product_type_repositories/product_type_repository.dart';
...
class GetAllProductTypesUsecaseImpl implements GetAllProductTypesUsecase {
  ...
  @override
  Future<Either<ApplicationError, ResponseEntity<List<ProductTypeEntity>>>> call(NoParams noParams) async {
