...
abstract class ProductUsecase implements Usecase<PaginationEntity<ProductEntity>, NoParams> {
  @override
  Future<Either<ApplicationError, PaginationEntity<ProductEntity>>> call(NoParams params);
}