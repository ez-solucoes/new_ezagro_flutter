...
abstract class CreateServiceOrderUsecase implements Usecase<FieldServiceOrderEntity, MockParams> {

  @override
  Future<Either<ApplicationError, FieldServiceOrderEntity>> call(MockParams mockParams);
}