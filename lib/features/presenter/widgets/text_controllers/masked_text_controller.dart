  ...
  void _maskText() {
    ...
    String _applyMaskTo(String text) {
      switch (maskType) {
        ...
        case MaskTypeEnum.brl : return _applyCurrencyMask(text.toUpperCase(), maskTypeString(MaskTypeEnum.brl));
        case MaskTypeEnum.usd : return _applyCurrencyMask(text.toUpperCase(), maskTypeString(MaskTypeEnum.usd));
        default : return text;
      }
    }
